...
describe('RoutePage', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    routeSpy = jasmine.createSpyObj('ActivatedRoute', [], {
      queryParams: {
        subscribe: (callback: any) => callback({ IdProceso: '123' })
      }
    });
  ...
  it('should initialize with process ID from route params', fakeAsync(async () => {
  ...
  it('should get destination position from process', fakeAsync(async () => {
  ...
  it('should use default destination when process has no destination', fakeAsync(async () => {
    const processWithoutDestination = { ...mockProceso, Destino: undefined };
    processesServiceSpy.get.and.returnValue(Promise.resolve(processWithoutDestination));
