...
describe('SubprocessesPage', () => {
  let component: SubprocessesPage;
  let fixture: ComponentFixture<SubprocessesPage>;
  ...
  beforeEach(async () => {
    ...
    transactionsServiceSpy = jasmine.createSpyObj('SubprocessesService', ['list']);
    ...
    fixture = TestBed.createComponent(SubprocessesPage);
  ...
  it('should load subprocesses on view enter', async () => {
    await component.ionViewWillEnter();

    expect(transactionsServiceSpy.list).toHaveBeenCalled();
  });

  it('should handle load subprocesses error', async () => {
