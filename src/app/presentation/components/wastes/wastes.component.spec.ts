...
describe('WastesComponent', () => {
  ...
  let inventoryServiceSpy: jasmine.SpyObj<InventoryRepository>;
  ...
  beforeEach(waitForAsync(() => {
    inventoryServiceSpy = jasmine.createSpyObj('InventoryRepository', ['list']);
    ...
    inventoryServiceSpy.getResidue.and.returnValue(Promise.resolve(mockResidues[0]));

    TestBed.configureTestingModule({
      declarations: [WastesComponent],
      imports: [IonicModule.forRoot(), FormsModule],
      providers: [
        { provide: InventoryRepository, useValue: inventoryServiceSpy },
  ...
  it('should load residues on initialization', async () => {
    ...
    expect(inventoryServiceSpy.getResidue).toHaveBeenCalled();
