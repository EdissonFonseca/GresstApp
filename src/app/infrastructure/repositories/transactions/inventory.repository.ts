...
import { Residuo } from "../../../domain/entities/residuo.entity";
import { Proceso } from "@app/domain/entities/proceso.entity";
import { Cuenta } from "../../../domain/entities/cuenta.entity";
import { StorageService } from "../api/storage.repository";
import { CRUD_OPERATIONS, SERVICE_TYPES, STORAGE } from "../../../core/constants";
import { MaterialsService } from "../masterdata/materials.repository";
import { PointsService } from "../masterdata/points.repository";
import { ThirdpartiesService } from "../masterdata/thirdparties.repository";
...
export class InventoryService {
  ...
  private activities = signal<Proceso[]>([]);
  ...
  private async loadData() {
    try {
      ...
      const actividades = await this.storage.get(STORAGE.ACTIVITIES) as Proceso[];
